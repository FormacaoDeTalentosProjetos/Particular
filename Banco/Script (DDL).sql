...
CREATE TABLE [dbo].[TB_MENTOR](
    [ID] INT IDENTITY NOT NULL,
    [IdUser] INT NOT NULL,
    CONSTRAINT [PK_CADMENTOR] PRIMARY KEY([ID]),
    CONSTRAINT [FK_CADMENTOR_USER] FOREIGN KEY(IdUser) REFERENCES TB_USER([ID])
)
GO
...
CREATE TABLE [dbo].[TB_MENTOR_TRIBO](
    ...
    CONSTRAINT [FK_MENTORTRIBO_MENTOR] FOREIGN KEY([IdMentor]) REFERENCES TB_CADMENTOR([ID])
)
GO
...
CREATE TABLE [dbo].[TB_MENTOR_SQUAD](
    ...
    CONSTRAINT [FK_MENTORSQUAD_MENTOR] FOREIGN KEY([IdMentor]) REFERENCES TB_CADMENTOR([ID])
)
GO